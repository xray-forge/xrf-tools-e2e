...
describe("info-ogf", () => {
  ...
  beforeAll(() => {
    ...
    minimal = box.run("info-ogf", ["--path", gamedata("meshes/ogf/part_none.ogf")]);
    prop = box.run("info-ogf", ["--path", gamedata("meshes/ogf/notes_paper_1.ogf")]);
    weapon = box.run("info-ogf", ["--path", gamedata("meshes/ogf/wpn_pm_lod.ogf")]);
  });
