...
describe("archive verify directory", () => {
  ...
  beforeAll(() => {
    ...
    result = box.run("archive verify", ["--path", box.at("archives")]);
  });

  it("should validate every file from every archive below the directory root", () => {
